...
class _MoneyInState extends State<MoneyIn> {
  ...
  // final totalMoneyInData = 0;
  // final totalMoneyOutData = 0;
  // final balance = 0;
  @override
  void initState() {
    super.initState();
    addTypeController = TextEditingController();
    addTypeController.text = "Money In";
        ...
        child: TextField(
          ...
          onTap: () async {
            ...
            if (pickedTime != null) {
              ...
              String formatTime = DateFormat('jm').format(parsedTime);
  ...
  //       ),
  //     );
  Future addMoneyIn() async {
    final docUser = FirebaseFirestore.instance
        .collection('Users')
        .doc(user.uid)
        .collection('Transactions')
        .doc();
    // final addTotals = Users(
    //   id: user.uid,
    //   image: '',
    //   username: '',
    //   password: '',
    //   email: '',
    //   totalMoneyIn: int.parse(amountController.text),
    //   totalMoneyOut: 0,
    //   balance: 0,
    // );
  ...
  // Future<String?> addSale({String}) async {
  //   CollectionReference users = _firestore.collection('USA');
  //   return 'created';
  // }
}
