...
class IncomeReport extends StatefulWidget {
  ...
  const IncomeReport({super.key, required this.transactions});
  @override
  State<IncomeReport> createState() =>
      // ignore: no_logic_in_create_state
      _IncomeReportState(transactions: transactions);
}

class _IncomeReportState extends State<IncomeReport> {
  Transactions transactions;
  _IncomeReportState({required this.transactions});
